...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Wolfcoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "wolfcoin",               "masternode",             &masternode,             true,  {} },
    { "wolfcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "wolfcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "wolfcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "wolfcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "wolfcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
