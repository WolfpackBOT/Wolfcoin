...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in wolfcoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("wolfcoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Wolfcoin features */
    { "wolfcoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "wolfcoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "wolfcoin",               "gobject",                &gobject,                true,  {} },
    { "wolfcoin",               "voteraw",                &voteraw,                true,  {} },
