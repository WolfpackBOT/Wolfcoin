...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case WOLF: return QString("Wolfcoin");
            case mWOLF: return QString("Milli-Wolfcoin (1 / 1" THIN_SP_UTF8 "000)");
            case uWOLF: return QString("Micro-Wolfcoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case Satoshi: return QString("Ten Nano-Wolfcoin (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case WOLF: return QString("TestWolfcoins");
            case mWOLF: return QString("Milli-TestWolfcoin (1 / 1" THIN_SP_UTF8 "000)");
            case uWOLF: return QString("Micro-TestWolfcoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case Satoshi: return QString("Ten Nano-TestWolfcoin (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
