...
This document provides guidelines for internationalization of the Wolfcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wolfcoin_en.ts` remains unchanged.
