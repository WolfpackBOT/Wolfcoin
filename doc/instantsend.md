...
This mechanism has been integrated into Bitcore-Node-Wolfcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wolfcoinpay/insight-api-wolfcoin#web-socket-api](https://github.com/wolfcoinpay/insight-api-wolfcoin#web-socket-api)
* API: [https://github.com/wolfcoinpay/insight-api-wolfcoin#instantsend-transactions](https://github.com/wolfcoinpay/insight-api-wolfcoin#instantsend-transactions)
...
By default, the Wolfcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Wolfcoin Core daemon:
